...
@SpringBootTest
@Sql(statements = {
        // Drop tables if they exist â€” order matters due to FK constraints
        ...
        // Create trips table â€” note FK references captains and customers
        "CREATE TABLE trips (" +
                "id SERIAL PRIMARY KEY, " +
        ...
        // Create payments table â€” FK to trips
